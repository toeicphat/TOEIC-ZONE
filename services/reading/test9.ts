    ...
    passages: [
        {
            ...
            questions: [
                { id: '101', questionText: 'Mr. Liu is known for negotiating employee disputes ------.', options: { A: 'calm', B: 'calmly', C: 'calmest', D: 'calmness' }, correctAnswer: 'B' },
                { id: '102', questionText: 'The city is accepting proposals for the redesign of Oshida Public Park ------ January 25.', options: { A: 'when', B: 'until', C: 'a few', D: 'whether' }, correctAnswer: 'B' },
                { id: '103', questionText: 'Sales ------ maintain client files and provide logistical support.', options: { A: 'assists', B: 'assisted', C: 'assisting', D: 'assistants' }, correctAnswer: 'D' },
                { id: '104', questionText: 'Tonight at Harbor Falls Library, writer Delroy Greene will be ------ stories from his childhood in Jamaica.', options: { A: 'dividing', B: 'sharing', C: 'using', D: 'awarding' }, correctAnswer: 'B' },
                { id: '105', questionText: 'Mr. Kam has invited all staff members to attend ------ retirement party.', options: { A: 'he', B: 'his', C: 'him', D: 'himself' }, correctAnswer: 'B' },
                ...
                { id: '113', questionText: 'Staff are invited to participate in a ------ of social events during the first week of May.', options: { A: 'series', B: 'status', C: 'theory', D: 'guest' }, correctAnswer: 'A' },
                { id: '114', questionText: 'The contract states that Solcus Corporation will be ------ for any costs resulting from work delays.', options: { A: 'accountable', B: 'manageable', C: 'knowledgeable', D: 'flexible' }, correctAnswer: 'A' },
                { id: '115', questionText: "Author Minh Phan's latest novel was ------ influenced by Vietnamese folk stories.", options: { A: 'heavy', B: 'heavily', C: 'heaviest', D: 'heavier' }, correctAnswer: 'B' },
                { id: '116', questionText: 'Tourists are expected to flock to the Sorachi Discovery Museum when it opens ------ in Mikasa, Hokkaido.', options: { A: 'soon', B: 'as', C: 'almost', D: 'initial' }, correctAnswer: 'A' },
                ...
                { id: '127', questionText: 'Rapid Books has the payroll solutions every company needs, allowing users ------ invoices in three easy steps.', options: { A: 'sent', B: 'have sent', C: 'sending', D: 'to send' }, correctAnswer: 'D' },
                { id: '128', questionText: 'Epky Electronics will open eight additional retail stores ------ the next two years.', options: { A: 'above', B: 'behind', C: 'about', D: 'within' }, correctAnswer: 'D' },
                { id: '129', questionText: 'The three-day workshop focuses on the public speaking ------ that are central to delivering memorable presentations.', options: { A: 'strategies', B: 'strategized', C: 'strategically', D: 'strategic' }, correctAnswer: 'A' },
                { id: '130', questionText: 'Critics agree that the movie An Unusual Introduction ------ combines computer-generated images and live action.', options: { A: 'seamlessly', B: 'collectively', C: 'factually', D: 'distantly' }, correctAnswer: 'A' },
            ]
        }
    ]
};
...
Thank you for flying Sky Air First with ---131.---. We hope you enjoy your flight. You can take advantage of our best prices on future flights ---132.--- purchasing a Sky Air First Pass. For a ---133.--- annual fee, you will get special discounts, seat upgrades, and the use of our exclusive travelers' lounge. ---134.---. Ask your flight attendant for more information and an application.`,
            questions: [
                { id: '131', questionText: 'Choose the best option for (131).', options: { A: 'them', B: 'theirs', C: 'us', D: 'ours' }, correctAnswer: 'C' },
                { id: '132', questionText: 'Choose the best option for (132).', options: { A: 'at', B: 'on', C: 'by', D: 'to' }, correctAnswer: 'C' },
                { id: '133', questionText: 'Choose the best option for (133).', options: { A: 'lowers', B: 'low', C: 'lowly', D: 'lowest' }, correctAnswer: 'B' },
                { id: '134', questionText: 'Choose the best option for (134).', options: { A: 'We hope you will fly Sky Air First again.', B: 'You will also get priority boarding.', C: 'Please find your seat immediately.', D: 'The flight delay will be minimal.' }, correctAnswer: 'B' }
            ]
        },
        {
...
Out and About in Queensville, which has been airing for 30 years, is performed live weekly from September to May in the Orpheum Theater in downtown Queensville. The show ---138.--- musical guests, writers, and storytellers for an hour of weekly programming.`,
            questions: [
                { id: '135', questionText: 'Choose the best option for (135).', options: { A: 'responsive', B: 'responsibly', C: 'responding', D: 'responsible' }, correctAnswer: 'D' },
                { id: '136', questionText: 'Choose the best option for (136).', options: { A: 'Even so', B: 'In fact', C: 'For example', D: 'In addition' }, correctAnswer: 'D' },
                { id: '137', questionText: 'Choose the best option for (137).', options: { A: 'CJOK was founded 60 years ago.', B: 'These recent hires follow the retirement of producer Ed Evans.', C: 'Ms. Dees was born and raised in Cedarburg.', D: 'CJOK has more than one popular show in its lineup.' }, correctAnswer: 'B' },
                { id: '138', questionText: 'Choose the best option for (138).', options: { A: 'gives', B: 'marks', C: 'features', D: 'holds' }, correctAnswer: 'C' }
            ]
        },
        {
...
Dear Ms. Barga:
We received your recent order asking for your name to be stitched on a Klamath Kool handbag. We are, ---139.---, eager to complete your order. Unfortunately, our seamstress who fulfills personalisation requirements will be on leave for the next three days. We wanted to let you know that her ---140.--- will cause a delay in shipping your bag.
---141.--- for the wait, we would like to offer you a 10 percent discount on your current order. Or, if you prefer, you can opt for free personalisation on your next order. ---142.---. At Northwest Bags, we strive for 100 percent customer satisfaction!

Sincerely,
Artie Romanche
Customer Service Representative, Northwest Bags`,
            questions: [
                { id: '139', questionText: 'Choose the best option for (139).', options: { A: 'still', B: 'besides', C: 'of course', D: 'nevertheless' }, correctAnswer: 'A' },
                { id: '140', questionText: 'Choose the best option for (140).', options: { A: 'absence', B: 'arrival', C: 'request', D: 'investigation' }, correctAnswer: 'A' },
                { id: '141', questionText: 'Choose the best option for (141).', options: { A: 'Compensated', B: 'To compensate', C: 'For compensating', D: 'It is compensation' }, correctAnswer: 'B' },
                { id: '142', questionText: 'Choose the best option for (142).', options: { A: 'The choice is yours.', B: 'We appreciate your review.', C: 'The bag will look great with your initials on it.', D: 'We are the only local retailer offering custom services.' }, correctAnswer: 'A' }
            ]
        },
        {
...
"Our contract with Novaseon to provide ---145.--- power moves us closer to our long-term corporate goal," said Sumit Varma, CEO of Sehelec. “Our objective is to achieve a capacity of 20 gigawatts within five years. Doing so will make us one of India's largest green power companies. And that, in turn, will help the country ---146.--- its carbon-reduction target."`,
            questions: [
                { id: '143', questionText: 'Choose the best option for (143).', options: { A: 'plant', B: 'planter', C: 'planting', D: 'planted' }, correctAnswer: 'A' },
                { id: '144', questionText: 'Choose the best option for (144).', options: { A: 'Windy conditions can cause damage to tall buildings.', B: 'The facility will consist of a mix of solar panels and wind turbines.', C: 'Electric vehicles have fewer emissions than other vehicles have.', D: "The pace of upgrades to India's power grid slowed slightly this year." }, correctAnswer: 'B' },
                { id: '145', questionText: 'Choose the best option for (145).', options: { A: 'renew', B: 'renewers', C: 'renewable', D: 'to renew' }, correctAnswer: 'C' },
                { id: '146', questionText: 'Choose the best option for (146).', options: { A: 'understand', B: 'explain', C: 'block', D: 'reach' }, correctAnswer: 'D' }
            ]
        }
    ]
};
...
Vegetable Wrap – Fresh tomato, cucumber, and carrots with hummus (made with our secret recipe) on flatbread`,
            questions: [
                { id: '147', questionText: 'What does each lunch special include?', options: { A: 'A soup', B: 'Carrots', C: 'Tomatoes', D: 'A beverage' }, correctAnswer: 'A' },
                { id: '148', questionText: 'What item contains an ingredient that is only available from Carina\'s Café?', options: { A: 'Turkey sandwich', B: 'Vegetable panini', C: 'Mushroom chicken cavatappi', D: 'Vegetable wrap' }, correctAnswer: 'D' }
            ]
        },
        {
...
The workshop costs $99 and will be held at Valley Floor Fitness in Missoula on August 27 from 9 a.m. to 5 p.m. For more information and to register, e-mail Maya Cramer at certification@valleyfloorfitness.com.`,
            questions: [
                { id: '149', questionText: 'The word "design” in paragraph 1, line 2, is closest in meaning to', options: { A: 'find', B: 'create', C: 'draw', D: 'name' }, correctAnswer: 'B' },
                { id: '150', questionText: 'What is indicated about the workshop?', options: { A: 'It will be held at a pool at Wilkinson University.', B: 'It is being offered on two different dates.', C: 'It is available at a discounted rate in August.', D: 'It will be taught by a former student of Valley Floor Fitness.' }, correctAnswer: 'D' }
            ]
        },
        {
...
Hugo Jones`,
            questions: [
                { id: '153', questionText: 'What does Mr. Jones indicate in his e-mail?', options: { A: 'He used to work with Ms. Navas.', B: 'He is an associate manager.', C: 'Another company wishes to hire him.', D: 'His interview has been scheduled for next week.' }, correctAnswer: 'C' },
                { id: '154', questionText: 'What does Mr. Jones want to know by the end of the week?', options: { A: 'Whether an important decision has been made yet', B: 'Whether Ms. Navas is available for a meeting', C: 'Whether Ms. Navas would like to apply for a new position', D: 'Whether the company will expand its product offerings' }, correctAnswer: 'A' }
            ]
        },
        {
...
To apply, please send CV and two references to jobs@camerleycorp.co.nz.`,
            questions: [
                ...
                { id: '162', questionText: 'What material is NOT specified in the advertisement?', options: { A: 'Metal', B: 'Glass', C: 'Wood', D: 'Plastic' }, correctAnswer: 'B' },
                { id: '163', questionText: 'What is listed as a requirement for the job?', options: { A: 'Training in business-to-business sales', B: 'A university degree in engineering', C: 'Experience creating technical drawings', D: 'The ability to work alone and with others' }, correctAnswer: 'D' }
            ]
        },
        {
...
**Terminal and Service Improvements:** Zealandia Airlines is participating in discussions with airport management about comprehensive renovations to its passenger lounge and café and has offered to commit $5 million from its budget to the project. Company executives have also finalized a plan and committed funds to overhaul its rewards program. The initiative supports the aim to be a leading service provider among similar airlines and capture an increasing percentage of the market share.`,
            questions: [
                ...
                { id: '170', questionText: 'What does Zealandia Airlines want to provide in the future?', options: { A: 'Private charter flights', B: 'Luxury travel tours', C: 'Commercial shipping', D: 'Aircraft leasing' }, correctAnswer: 'C' },
                { id: '171', questionText: 'How does Zealandia Airlines hope to improve service for passengers?', options: { A: 'By remodeling the passenger waiting area', B: 'By moving to a new location within the terminal', C: 'By upgrading the seating inside the aircraft', D: 'By offering improved meal service on all flights' }, correctAnswer: 'A' }
            ]
        },
        {
...
Best,
Hae-won Jeong, Digital Marketing Director, The 3R Marketing Firm`,
            questions: [
                { id: '191', questionText: 'What is the purpose of the first e-mail?', options: { A: 'To schedule a meeting with a client', B: 'To ask for assistance with a project', C: 'To seek a suggestion from a colleague', D: 'To congratulate a colleague who was promoted' }, correctAnswer: 'C' },
                { id: '192', questionText: 'According to the list, what is suggested about the Bonita Suites Hotel?', options: { A: 'It is located in a historic building.', B: 'It features resources for business travelers.', C: 'It is near many downtown tourist attractions.', D: 'It charges a daily fee for parking.' }, correctAnswer: 'B' },
                { id: '193', questionText: 'What is true about Ms. Jeong?', options: { A: 'She has not attended a marketing conference before.', B: 'She prefers the Alessi Dallas Hotel for its restaurant.', C: 'She thinks Ms. Laurent should stay at the Bonita Suites Hotel.', D: 'She works for a different company than Ms. Laurent.' }, correctAnswer: 'C' },
                { id: '194', questionText: 'Why would Ms. Jeong most likely suggest that Ms. Laurent avoid the Oaktree Hotel?', options: { A: 'It does not have an on-site restaurant.', B: "Its room rate exceeds the company's limit.", C: 'Its clients are mostly noisy tourists.', D: 'It is too far from the conference location.' }, correctAnswer: 'B' },
                { id: '195', questionText: 'What does the second e-mail indicate about the National Digital Marketing Conference?', options: { A: 'Its location changes to a different city each year.', B: 'Last year it was held at the Alessi Dallas Hotel.', C: 'Ms. Jeong is on its executive planning committee.', D: 'It includes an event for first-time attendees.' }, correctAnswer: 'D' }
            ]
        },
        {
...
Best regards,
Ramona Hizon, Customer Support, Dover Water Supply`,
            questions: [
                { id: '196', questionText: 'What is one purpose of the letter?', options: { A: 'To list customer benefits', B: 'To alert customers to a price change', C: 'To confirm the start of a service', D: 'To describe changes to a Web site' }, correctAnswer: 'C' },
                { id: '197', questionText: 'What most likely does Ms. Cam want to do online on May 15?', options: { A: 'Request a new water meter', B: 'Complete a customer survey', C: 'Report a leaking pipe', D: 'Pay a water bill' }, correctAnswer: 'D' },
                { id: '198', questionText: 'According to the second e-mail, what should Ms. Cam do on April 6?', options: { A: 'Boil her drinking water for five minutes', B: 'Allow her water to run for some time', C: 'Contact her neighbors', D: 'Request a service visit' }, correctAnswer: 'B' },
                { id: '199', questionText: 'In the second e-mail, what is indicated about the water from Dover Water Supply?', options: { A: 'It is safe to use.', B: 'It is measured every month.', C: 'It is distributed to many cities.', D: 'It is naturally free of minerals.' }, correctAnswer: 'A' },
                { id: '200', questionText: 'What can be concluded about Ms. Hizon?', options: { A: "She resolved the issue with Ms. Cam's account.", B: 'She sent a copy of the water analysis to Ms. Cam.', C: 'She will offer Ms. Cam a discount for new customers.', D: "She lives in Ms. Cam's area." }, correctAnswer: 'A' }
            ]
        }
    ]
};

export const test9Data = {
    part5: test9Part5,
    part6: test9Part6,
    part7: test9Part7,
};
